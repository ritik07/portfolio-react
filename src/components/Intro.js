            ...
            <Fade top>
                ...
                <div className="col-md-6 d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div className="home_title">
                        ...
                        <Fade top delay={200}>
                        <div className="d-xl-flex justify-content-xl-start mb-40"><button className="btn" type="button" style={{backgroundColor: "#4070f4",color: theme.btntxtclr}}>Download Resume</button></div>
                        </Fade>
